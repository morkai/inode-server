...
module.exports = function setUpSlave(app, slaveConfig)
{
  ...
  if (slaveConfig.listener
    && slaveConfig.listener.type === 'ws'
    && slaveConfig.listener.serverOptions
    && app.http
    && slaveConfig.listener.serverOptions.host === app.http.config.host
    && slaveConfig.listener.serverOptions.port === app.http.config.port)
  {
    slaveConfig.listener.serverOptions.server = app.http.server;
  }
